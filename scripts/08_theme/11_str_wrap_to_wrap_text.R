...
world_bank_countries %>% 
  ...
  labs(
    ...
    subtitle = "In Europe and Africa, the number of overweight people decreased from 2000 to 2016, while the number of overweight people increased in the other continents.",
